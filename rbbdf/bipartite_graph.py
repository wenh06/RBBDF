                ...
                col_nodes=sorted(
                    list(
                        set(
                            [
                                c
                                for c in self.col_nodes
                                if any([(r, c) in self.edges for r in border_row_nodes])
                            ]
                        )
                    )
                ),
                    ...
                    list(
                        set(
                            [
                                e
                                for e in self.edges
                                if any([r in e for r in border_row_nodes])
                            ]
                        )
                    )
                ),
                ...
                row_nodes=sorted(
                    list(
                        set(
                            [
                                r
                                for r in self.row_nodes
                                if any([(r, c) in self.edges for c in border_col_nodes])
                            ]
                        )
                    )
                ),
                    ...
                    list(
                        set(
                            [
                                e
                                for e in self.edges
                                if any([c in e for c in border_col_nodes])
                            ]
                        )
                    )
                ),
